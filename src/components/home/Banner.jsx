...
const Banner = () => {
  return (
    <div className="h-150 md:h-200 flex items-center justify-center relative overflow-hidden bg-[url('/images/banner2.jpg')] bg-cover bg-center">
      <div className="absolute inset-0 bg-black/75 flex flex-col items-center justify-center text-center px-6">
        ...
        <p className="mt-4 text-[20px] md:text-xl text-gray-300 max-w-2xl">
